			...
			<div class="row center">
				<div class="column small-full medium-three-quarter">
					<div class="content">
						...
						<p>
							All participants of Henri's are expected to abide by our Code of
							Conduct, both online and during in-person events that are hosted
							and/or associated with Henri's.
						</p>
					</div>
				</div>
			</div>
...
<h4>Enforcement</h4>
<p>Violations of the Code of Conduct may be reported by sending an email to <a href="mailto:info@silvandiepen.com">info@silvandiepen.com</a>. All reports will be reviewed and investigated and will result in a response that is deemed necessary and appropriate to the circumstances. Further details of specific enforcement policies may be posted separately.</p>
