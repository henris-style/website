<template>
	<div class="page page--code-of-conduct">
			...
			<div class="row center">
				<div class="column small-full medium-three-quarter">
					<div class="content">
						...
						<p>
							All participants of Henri's are expected to abide by our Code of Conduct, both online and during in-person events
							that are hosted and/or associated with Henri's.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="column small-full medium-three-quarter">
					<div class="content">
						...
						<ul>
							...
							<li>
								Assuming or promoting any kind of inequality including but not limited to: age, body size, disability,
						...
						<p>
							...
							<a href="mailto:info@silvandiepen.com">info@silvandiepen.com</a>. All reports will be reviewed and investigated
							and will result in a response that is deemed necessary and appropriate to the circumstances. Further details of
							specific enforcement policies may be posted separately.
						</p>

						<p>
							We hold the right and responsibility to remove comments or other contributions that are not aligned to this Code
							of Conduct, or to ban temporarily or permanently any members for other behaviours that they deem inappropriate,
							threatening, offensive, or harmful.
						</p>

						<h4>Attribution</h4>
						<p>This Code of Conduct is adapted from <a href="https://dev.to">dev.to</a>.</p>
					</div>
				</div>
			</div>
		</section>
