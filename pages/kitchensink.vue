<template>
	<div class="page page--kitchensink">
		...
		<section class="basic basic-content kitchensink">
			<div class="row center">
				<div class="column small-full medium-three-quarter">
					<div class="content">
    ...
    height: 80px;
						...
						<section class="html-tags">
							...
							<p>
								...
								I am <abbr title="Abbreviation">the abbr tag</abbr> example<br />
								...
								I am the
								<span class="highlight">highlight class</span> example<br />
							</p>
						</section>
						<section class="forms">
							<h3>Forms</h3>
							...
							<form action="#">
								<fieldset>
									...
									<div>
										...
										<a href="#" class="button negative">Cancel</a>
									</div>
								</fieldset>
							</form>
						</section>
